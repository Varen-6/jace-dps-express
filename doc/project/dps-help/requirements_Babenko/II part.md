...
```
## 4. Запуск підсистеми документації jace-doc

* запустити сервер:
```
npm start
```
* розпочати генерацію документації
```
npm run jace-doc
```
Після успішного запуску відкриваємо браузер та переходимо за посиланням

*http://localhost:8098/doc/*
